...
$db = "A891481_SATENSDB";
	...
	if(isset($_GET['leadid']) && intval($_GET['leadid'])) {
		...
		// Delete all from leaid id
		$query = "DELETE FROM A891481_SATENSDB.wp_rg_lead_detail  WHERE lead_id = $user_id ";

		//$query = "SELECT *, FROM A891481_SATENSDB.wp_rg_lead_detail WHERE lead_id = $user_id ";
