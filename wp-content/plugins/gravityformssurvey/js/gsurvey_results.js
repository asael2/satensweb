...
var gresults = {
    ...
    getFilterFields:function () {
        ...
        for (i = 0; i < gresultsFilters.length; i++) {
            ...
            if (gresultsFilters[i].type == 'group') {
                ...
                disabled = ! gresultsFilters[i].allowMultiple && gresults.isFieldSelected(key) ? "disabled='disabled'" : "";
    ...
    setDisabledFields:function () {
        ...
        jQuery("select.gresults-filter-field").each(function (i) {
            ...
            if ( filter && filter.preventMultiple && gresults.isFieldSelected(this.value)) {
