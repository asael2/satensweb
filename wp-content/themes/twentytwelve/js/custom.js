	...
	function velocimetros (nRespuestas, targetDom, formNumb) {
		if(nRespuestas){
			...
			var options = {
				...
				backgroundColor: {strokeWidth: 0, fill: 'whiteSmoke',},
			};
...
$(function () {
	...
	if( $.urlParam('leadid') && $.urlParam('form') && $.urlParam('edit') )  {
		...
		$(".detail_gsection_title:contains('Sección 2: Manejo de Cuenta de Cheques / Manejo de Dinero')").closest('tr').after("<tr class='guideImg2'></tr>");
		$(".guideImg2").html(" <img src= 'http://www.satenspr.com/wp-content/uploads/2013/05/cheque.png' /> ")

		$(".detail_gsection_title:contains('Sección 3: Gráficas')").closest('tr').after("<tr class='guideImg3'></tr>");
		$(".guideImg3").html(" <img src= 'http://www.satenspr.com/wp-content/uploads/2013/07/grafica.png' /> ")
