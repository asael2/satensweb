...
//F1
	...
	siNoColumnChart(DS_22, ".form1", "Recibe servicios en la escuela por algunas dificultades académicas, problemas de salud o impedimento");
	
	laDataTable(DS_23, ".form1");
	velocimetros(DS_24_26, ".form1");
	laDataTable(DS2_24_26, ".form1");
	laDataTable(DS_27, ".form1");

	formBreak(".form1", "Intereses y Actividades Generales");
	siNoColumnChart(DS_29, ".form1", "Diversión en Tiempo Libre");
	siNoColumnChart(DS_30, ".form1", "Tareas y Responsabilidades en el Hogar");
	siNoColumnChart(DS_31, ".form1", "Aspiración a una Carrera en el Futuro");

	formBreak(".form1", "Intereses y Metas de Estudios Generales");
	laDataTable(DS_41, ".form1");
	laDataTable(DS_42, ".form1");
	pieChart(DS_35_39, ".form1", 'Porciento de Ocupaciones Seleccionadas por el Estudiante Relacionadas a Datos, Gente y Cosas');	

//F2
	formBreak(".form2", "Cuestionario al Padre o Encargado");
	laDataTable(DS_45, ".form2");
	laDataTable(DS_47, ".form2");
	siNoColumnChart(DS_49, ".form2", "Conoce si su hijo/a tiene alguna experiencia de trabajo (part time)");
	laDataTable(DS_50, ".form2");
	siNoColumnChart(DS_51, ".form2", "Opinión sobre si su hijo/a necesita mejorar en sus destrezas sociales para aumentar sus oportunidades de empleo y estudios futuros");
	laDataTable(DS_52, ".form2");
	siNoColumnChart(DS_54, ".form2", "Ocupaciones en o fuera de la escuela.");
	pieChart(DS_55_59, ".form2", 'Porciento de Ocupaciones Seleccionadas por el Estudiante Relacionadas a Datos, Gente y Cosas');	
	siNoColumnChart(DS_61, ".form2", "¿Tiene usted alguna preocupación en relación al desarrollo académico y ocupacional de su hijo/a?");

//F3
/*
	formBreak(".form3", "Trabajo en la Escuela al Presente y Planes Futuros");
	siNoColumnChart(DS_64, ".form3", "Conoce si su hijo/a tiene alguna experiencia de trabajo (part time)");
	siNoColumnChart(DS_65, ".form3", "Al presente necesita ayuda para hacer sus tareas en las clases");
	laDataTable(DS_67, ".form3");
	siNoColumnChart(DS_68,  ".form3", "Busca ayuda cuando tiene dificultades en las clases");
	siNoColumnChart(DS_85,  ".form3", "Si está satisfecho/a con los cursos que toma al presente en la escuela");

	formBreak(".form3", "Experiencias del Diario Vivir | Comunitarias");
	laDataTableDos(DS_70_75, ".form3");
	
	formBreak(".form3", "Planes Después de Terminar la Escuela Superior");
	laDataTable(DS_77, ".form3");
	laDataTable(DS_79, ".form3");

	siNoColumnChart(DS_81, ".form3");
	siNoColumnChart(DS_82, ".form3");
	laDataTable(DS_83, ".form3");
*/
}/////////////////////////////////////////////////////////////////////////
